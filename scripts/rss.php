...
$sql = "select c.* from wdi_tiles t, wdi_changesets c where t.changeset_id = c.changeset_id $bbox_query $editor_query $user_query group by c.changeset_id order by c.change_time desc limit 50";
$res = $db->query($sql);
print <<<"XML"
...
while( $row = $res->fetch_assoc() ) {
    ...
    $desc .= "<a href=\"https://osmcha.org/${row['changeset_id']}\">Show it on OSMChA</a>. ";
